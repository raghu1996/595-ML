...
def train(
    ...
    with tf.name_scope('Inputs'), tf.device("/CPU:0"):
        ...
        print("Noisy input:",noisy_input.eval().shape); #Raghu
        print("Clean Target:",clean_target.eval().shape); #Raghu
    ...
    for i in range(iteration_count):
        ...
        if i % eval_interval == 0:
            ...
            print("Noisy input2:",noisy_input); #Raghu
            print("Clean Target2:",clean_target); #Raghu
