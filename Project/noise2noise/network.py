...
def autoencoder(x, width=256, height=256, **_kwargs):
    ...
    skips.append(n)
    print("4.",np.shape(n))
    ##Raghu added additional conv layers to increase model capacity
    ...
    #n = conv_lr('enc_conv7', n, 48)
    #n = maxpool2d(n)
    #skips.append(n)
    
    ##Raghu end of additional layers
    ...
    #n = upscale2d(n)
    #print("5.",np.shape(n),np.shape(skips[-1]))
    #n = tf.concat([n, skips.pop()], axis=1)
    #n = conv_lr('dec_conv8', n, 96)
    #n = conv_lr('dec_conv8b', n, 96)
    
    
    #n = upscale2d(n)
    #n = tf.concat([n, skips.pop()], axis=1)
    #n = conv_lr('dec_conv7', n, 96)
    #n = conv_lr('dec_conv7b', n, 96)
    
    #n = upscale2d(n)
    #n = tf.concat([n, skips.pop()], axis=1)
    #n = conv_lr('dec_conv6', n, 96)
    #n = conv_lr('dec_conv6b', n, 96)
